    ...
    <div style={{minHeight:"100vh",background:W.bg,padding:"24px 16px",fontFamily:font}}>
      <div style={{maxWidth:720,margin:"0 auto"}}>
        <div style={{textAlign:"center",marginBottom:28,paddingTop:12}}>
          ...
          <p style={{color:W.sub,fontSize:18,margin:"6px 0 0"}}>128 Official USCIS 2025 Questions</p>
          <p style={{color:W.sub,fontSize:18,margin:"6px 0 0"}}>Created by <span style={{color:"#1e293b",fontSize:22,fontWeight:700}}>Sandra Chávez</span></p>
          <p style={{color:"#2563eb",fontSize:18,fontWeight:500,margin:"2px 0 0"}}>Only for personal study purposes, for Texas</p>
