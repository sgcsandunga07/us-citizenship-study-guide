...
const questions = [
  ...
  { id:17, q:"What are the two parts of the U.S. Congress?", a:"The Senate and House (of Representatives)", cat:"System of Government", ctx:"The bicameral (two-chamber) Congress resulted from the 'Great Compromise' at the 1787 Convention. Large states wanted representation by population (the Virginia Plan), while small states wanted equal representation (the New Jersey Plan). The compromise gave them both.", ctxEs:"El Gran Compromiso de 1787: estados grandes querían representación por población; pequeños, igualitaria. El compromiso les dio ambas cámaras." },
  { id:18, q:"How many U.S. Senators are there?", a:"One hundred (100)", cat:"System of Government", ctx:"Each state gets exactly 2 senators regardless of population. Wyoming (population ~580,000) has the same Senate representation as California (population ~39 million). Originally, senators were chosen by state legislatures; the 17th Amendment (1913) changed this to direct popular election.", ctxEs:"Cada estado tiene 2 senadores sin importar población. Wyoming tiene igual representación que California. La Enmienda 17 (1913) cambió a elección popular directa." },
  { id:19, q:"We elect a U.S. Senator for how many years?", a:"Six (6)", cat:"System of Government", ctx:"The Founders gave senators longer terms than representatives (6 vs. 2 years) to insulate them from short-term public passions. Senate terms are staggered so only about 1/3 of seats are up for election every 2 years, providing continuity.", ctxEs:"Mandatos de 6 años para aislarlos de pasiones a corto plazo. Escalonados: solo ~1/3 se elige cada 2 años." },
  { id:20, q:"Who is one of your state's U.S. Senators now?", a:"Ted Cruz (R) / John Cornyn (R)", cat:"System of Government" },
  { id:21, q:"The House of Representatives has how many voting members?", a:"Four hundred thirty-five (435)", cat:"System of Government", ctx:"The number 435 was fixed by the Reapportionment Act of 1929. Before that, the House grew with each census. After every 10-year census, the 435 seats are redistributed among states based on population changes — a process called reapportionment.", ctxEs:"Fijado en 435 por la Ley de 1929. Cada 10 años, los escaños se redistribuyen según el censo." },
  { id:22, q:"We elect a U.S. Representative for how many years?", a:"Two (2)", cat:"System of Government", ctx:"The short 2-year term was designed to keep Representatives closely accountable to the people. As the 'People's House,' members must frequently face voters, making it the most directly democratic part of the federal government.", ctxEs:"El mandato de 2 años mantiene a los Representantes responsables. La \"Cámara del Pueblo\" es la parte más democrática del gobierno." },
  { id:23, q:"Name your U.S. Representative.", a:"Depends on your district — Texas has 38. Visit house.gov/representatives to find yours", cat:"System of Government" },
  { id:24, q:"Who does a U.S. Senator represent?", a:"All people of the state", cat:"System of Government" },
  { id:25, q:"Why do some states have more Representatives than other states?", a:"(Because of) the state's population / (Because) they have more people / (Because) some states have more people", cat:"System of Government", ctx:"This proportional representation was part of the Great Compromise. The U.S. Census, conducted every 10 years since 1790, determines how many Representatives each state receives. Currently, each Representative serves roughly 760,000 people.", ctxEs:"Representación proporcional del Gran Compromiso. El Censo cada 10 años determina la distribución. Cada Representante sirve a ~760,000 personas." },
  { id:26, q:"We elect a President for how many years?", a:"Four (4)", cat:"System of Government", ctx:"George Washington set the precedent of serving only two terms. This was tradition until Franklin Roosevelt won four terms (1932-1944). After FDR's death in office, the 22nd Amendment (1951) formally limited presidents to two terms.", ctxEs:"Washington estableció el precedente de dos mandatos. FDR ganó cuatro. La Enmienda 22 (1951) los limitó formalmente a dos." },
  { id:27, q:"In what month do we vote for President?", a:"November", cat:"System of Government", ctx:"Congress set Election Day as the first Tuesday after the first Monday in November in 1845. The date was chosen because November was after harvest season (farmers could travel to vote) and Tuesday avoided conflicts with the Sabbath and Wednesday market days.", ctxEs:"El Congreso fijó las elecciones en noviembre de 1845: después de cosecha y martes para evitar conflictos con Sabbat y mercados." },
  ...
  { id:30, q:"If the President can no longer serve, who becomes President?", a:"The Vice President", cat:"System of Government", ctx:"This succession has occurred nine times: eight due to presidential deaths (4 assassinations, 4 natural causes) and once due to resignation (Nixon, 1974). The 25th Amendment (1967) formalized the process after JFK's assassination highlighted gaps in the original rules.", ctxEs:"Ha ocurrido 9 veces: 8 por muerte y 1 por renuncia (Nixon, 1974). La Enmienda 25 (1967) formalizó el proceso tras el asesinato de JFK." },
  { id:31, q:"If both the President and the Vice President can no longer serve, who becomes President?", a:"The Speaker of the House", cat:"System of Government", ctx:"The Presidential Succession Act of 1947 established the full line of succession: Speaker of the House, President Pro Tempore of the Senate, then Cabinet members starting with the Secretary of State. This line has never been invoked beyond the Vice President.", ctxEs:"La Ley de Sucesión de 1947: Speaker, Presidente Pro Tempore del Senado, luego Gabinete. Nunca se ha invocado más allá del Vicepresidente." },
  { id:32, q:"Who is the Commander in Chief of the military?", a:"The President", cat:"System of Government", ctx:"The Founders placed the military under civilian control to prevent military dictatorships common in Europe. While the President commands the armed forces, only Congress can declare war — a deliberate split of war powers. The last formal declaration of war was in 1942 (WWII).", ctxEs:"Control civil sobre militares para prevenir dictaduras. Solo el Congreso declara guerra. Última declaración formal: 1942." },
  { id:33, q:"Who signs bills to become laws?", a:"The President", cat:"System of Government" },
  { id:34, q:"Who vetoes bills?", a:"The President", cat:"System of Government", ctx:"The veto power comes from Article I of the Constitution. Congress can override a veto with a 2/3 vote in both chambers, but this is rare — only about 7% of vetoes have been overridden in U.S. history. The first presidential veto was by George Washington in 1792.", ctxEs:"El veto viene del Artículo I. Solo ~7% han sido anulados. El primer veto fue de Washington en 1792." },
  { id:35, q:"What does the President's Cabinet do?", a:"Advises the President", cat:"System of Government", ctx:"The Cabinet is not mentioned in the Constitution — it evolved from George Washington's practice of meeting with his department heads (Jefferson, Hamilton, Knox, and Randolph). Today there are 15 executive departments, each headed by a Secretary confirmed by the Senate.", ctxEs:"El Gabinete no está en la Constitución — evolucionó de la práctica de Washington. Hoy hay 15 departamentos con Secretarios confirmados por el Senado." },
  { id:36, q:"What are two Cabinet-level positions?", a:"Secretary of Agriculture / Secretary of Commerce / Secretary of Defense / Secretary of Education / Secretary of Energy / Secretary of Health and Human Services / Secretary of Homeland Security / Secretary of State / Secretary of the Treasury / Attorney General / Vice President", cat:"System of Government", ctx:"The oldest Cabinet positions are State, Treasury, and War (now Defense), created in 1789. The newest is Homeland Security, created after the September 11, 2001 attacks. The Attorney General heads the Department of Justice and is the nation's chief law enforcement officer.", ctxEs:"Estado, Tesoro y Guerra (Defensa) son de 1789. El más nuevo es Seguridad Nacional, tras el 11-S." },
  { id:37, q:"What does the judicial branch do?", a:"Reviews laws / Explains laws / Resolves disputes / Decides if a law goes against the Constitution", cat:"System of Government", ctx:"The power of 'judicial review' — declaring laws unconstitutional — was established in Marbury v. Madison (1803) by Chief Justice John Marshall. This landmark case made the Supreme Court a co-equal branch and is considered one of the most important decisions in American legal history.", ctxEs:"La revisión judicial fue establecida en Marbury vs. Madison (1803) por el Juez Marshall. Hizo de la Corte una rama co-igual." },
  { id:38, q:"What is the highest court in the United States?", a:"The Supreme Court", cat:"System of Government", ctx:"The Supreme Court first met in 1790 in New York City. It has shaped American life through landmark decisions: Brown v. Board of Education (1954) ended school segregation, Miranda v. Arizona (1966) established the right to remain silent, and many others.", ctxEs:"Se reunió por primera vez en 1790. Brown vs. Board of Education (1954) terminó segregación escolar; Miranda vs. Arizona (1966) estableció derecho al silencio." },
  { id:39, q:"How many justices are on the Supreme Court?", a:"Nine (9)", cat:"System of Government", ctx:"The Constitution doesn't specify the number of justices — Congress sets it. The Court has had as few as 5 and as many as 10 justices. It's been set at 9 since 1869. FDR tried to expand it in 1937 ('court-packing plan') but Congress rejected the idea.", ctxEs:"La Constitución no especifica el número de jueces. Ha habido desde 5 hasta 10. Fijado en 9 desde 1869." },
  { id:40, q:"Who is the Chief Justice of the United States now?", a:"John Roberts", cat:"System of Government" },
  { id:41, q:"Under our Constitution, some powers belong to the federal government. What is one power of the federal government?", a:"To print money / To declare war / To create an army / To make treaties", cat:"System of Government", ctx:"The Constitution's 'Enumerated Powers' (Article I, Section 8) list specific federal powers. Under the Articles of Confederation, the federal government couldn't even collect taxes or regulate trade — weaknesses that led to the Constitutional Convention.", ctxEs:"Los Poderes Enumerados listan poderes federales. Bajo los Artículos, no podían recaudar impuestos ni regular comercio." },
  { id:42, q:"Under our Constitution, some powers belong to the states. What is one power of the states?", a:"Provide schooling and education / Provide protection (police) / Provide safety (fire departments) / Give a driver's license / Approve zoning and land use", cat:"System of Government", ctx:"The 10th Amendment reserves all powers not specifically given to the federal government to the states or the people. This 'federalism' allows states to serve as 'laboratories of democracy,' testing different policies — a term coined by Justice Louis Brandeis in 1932.", ctxEs:"La Enmienda 10 reserva poderes no otorgados al federal a los estados. \"Federalismo\" permite estados como \"laboratorios de democracia\" (Brandeis, 1932)." },
  ...
  { id:48, q:"There are four amendments to the Constitution about who can vote. Describe one of them.", a:"Citizens eighteen (18) and older can vote / You don't have to pay a poll tax to vote / Any citizen can vote (women and men) / A male citizen of any race can vote", cat:"Rights and Responsibilities", ctx:"Voting rights expanded over nearly 200 years: the 15th Amendment (1870) prohibited racial discrimination in voting, the 19th (1920) gave women the vote, the 24th (1964) banned poll taxes, and the 26th (1971) lowered the voting age to 18 — partly because 18-year-olds were being drafted to fight in Vietnam.", ctxEs:"Derechos de voto expandidos en 200 años: Enmienda 15 (raza), 19 (mujeres), 24 (impuestos electorales), 26 (edad 18, por Vietnam)." },
  { id:49, q:"What is one responsibility that is only for United States citizens?", a:"Serve on a jury / Vote in a federal election", cat:"Rights and Responsibilities", ctx:"The right to a jury trial dates back to English common law and was so important to the Founders that it appears in both the Constitution and the Bill of Rights (6th and 7th Amendments). Jury service is considered a civic duty and a check on government power.", ctxEs:"El juicio por jurado viene del derecho inglés. Aparece en la Constitución y la Carta de Derechos (Enmiendas 6a y 7a)." },
  ...
  { id:51, q:"What are two rights of everyone living in the United States?", a:"Freedom of expression / Freedom of speech / Freedom of assembly / Freedom to petition the government / Freedom of religion / The right to bear arms", cat:"Rights and Responsibilities", ctx:"The Constitution protects these rights for all people in the U.S., not just citizens. The Supreme Court confirmed in Yick Wo v. Hopkins (1886) that the 14th Amendment's equal protection applies to all persons within U.S. jurisdiction, regardless of citizenship status.", ctxEs:"Protege a todos en EE.UU., no solo ciudadanos. Yick Wo vs. Hopkins (1886) confirmó que la protección igualitaria aplica sin importar estatus migratorio." },
  { id:52, q:"What do we show loyalty to when we say the Pledge of Allegiance?", a:"The United States / The flag", cat:"Rights and Responsibilities", ctx:"The Pledge was written in 1892 by Francis Bellamy for a Columbus Day celebration. 'Under God' was added in 1954 during the Cold War to distinguish the U.S. from atheistic communism. The Supreme Court ruled in 1943 that students cannot be forced to recite the Pledge.", ctxEs:"Escrito en 1892 por Bellamy. \"Bajo Dios\" agregado en 1954 (Guerra Fría). La Corte dictaminó en 1943 que nadie puede ser obligado a recitarlo." },
  { id:53, q:"What is one promise you make when you become a United States citizen?", a:"Give up loyalty to other countries / Defend the Constitution and laws of the United States / Obey the laws of the United States / Serve in the U.S. military (if needed) / Serve (do important work for) the nation (if needed) / Be loyal to the United States", cat:"Rights and Responsibilities", ctx:"The Oath of Allegiance has roots going back to the American Revolution. The current form was established by the Immigration and Nationality Act of 1952. Each year, roughly 600,000-900,000 people take this oath in naturalization ceremonies across the country.", ctxEs:"El Juramento tiene raíces en la Revolución. Forma actual de 1952. Cada año ~600,000-900,000 personas lo toman en ceremonias de naturalización." },
  { id:54, q:"How old do citizens have to be to vote for President?", a:"Eighteen (18) and older", cat:"Rights and Responsibilities", ctx:"Before the 26th Amendment (1971), the voting age was 21 in most states. The Vietnam War drove the change — the slogan 'old enough to fight, old enough to vote' reflected outrage that 18-year-olds could be drafted but couldn't vote. It was ratified in just 107 days, the fastest ever.", ctxEs:"Antes de la Enmienda 26 (1971), la edad era 21. Vietnam impulsó el cambio: \"si puedes pelear, puedes votar\". Ratificada en 107 días, la más rápida." },
  ...
  { id:56, q:"When is the last day you can send in federal income tax forms?", a:"April 15", cat:"Rights and Responsibilities", ctx:"The federal income tax was established by the 16th Amendment in 1913. Before that, the government was funded mainly by tariffs and excise taxes. The first income tax was actually a temporary measure during the Civil War (1861-1872) to fund the war effort.", ctxEs:"El impuesto sobre la renta fue establecido por la Enmienda 16 (1913). El primero fue temporal durante la Guerra Civil (1861-1872)." },
  { id:57, q:"When must all men register for the Selective Service?", a:"At age eighteen (18) / Between eighteen (18) and twenty-six (26)", cat:"Rights and Responsibilities", ctx:"The Selective Service System was established in 1917 for World War I. The military draft was used through the Vietnam War and ended in 1973. Registration continued after 1980 when President Carter reinstated it following the Soviet invasion of Afghanistan. No one has been drafted since 1973.", ctxEs:"Servicio Selectivo desde 1917. Reclutamiento terminó en 1973. Carter lo restableció en 1980 tras la invasión soviética de Afganistán." },

  // Colonial Period and Independence
  { id:58, q:"What is one reason colonists came to America?", a:"Freedom / Political liberty / Religious freedom / Economic opportunity / Practice their religion / Escape persecution", cat:"Colonial Period and Independence", ctx:"The Pilgrims (1620) fled religious persecution in England. The Puritans followed in the 1630s. Maryland was founded as a haven for Catholics (1632), Pennsylvania for Quakers (1681). Others came seeking economic opportunity — Virginia's Jamestown (1607) was founded as a business venture.", ctxEs:"Peregrinos (1620) huyeron de persecución. Maryland para católicos (1632), Pensilvania para cuáqueros (1681). Jamestown (1607) fue empresa comercial." },
  { id:59, q:"Who lived in America before the Europeans arrived?", a:"American Indians / Native Americans", cat:"Colonial Period and Independence", ctx:"Native Americans had lived on the continent for at least 15,000 years before European contact. When Columbus arrived in 1492, an estimated 5-15 million indigenous people lived in North America, speaking hundreds of languages and living in diverse societies from the Iroquois Confederacy to Pueblo cliff dwellers.", ctxEs:"Nativos americanos vivieron 15,000+ años antes del contacto europeo. En 1492, ~5-15 millones vivían en América del Norte." },
  { id:60, q:"What group of people was taken to America and sold as slaves?", a:"Africans / People from Africa", cat:"Colonial Period and Independence", ctx:"The first enslaved Africans arrived in Virginia in 1619. Over the next 250 years, approximately 12.5 million Africans were forcibly transported across the Atlantic in the slave trade. By 1860, nearly 4 million people were enslaved in the United States. Slavery wasn't abolished until the 13th Amendment in 1865.", ctxEs:"Primeros esclavizados llegaron a Virginia en 1619. En 250 años, ~12.5 millones transportados. Para 1860, 4 millones esclavizados. Abolida con Enmienda 13 (1865)." },
  { id:61, q:"Why did the colonists fight the British?", a:"Because of high taxes (taxation without representation) / Because the British army stayed in their houses / Because they didn't have self-government", cat:"Colonial Period and Independence", ctx:"After the costly French and Indian War (1754-1763), Britain imposed new taxes on the colonies — the Stamp Act (1765), Townshend Acts (1767), and Tea Act (1773). Colonists protested with 'no taxation without representation.' The Boston Tea Party (1773) and the 'Intolerable Acts' pushed the colonies toward revolution.", ctxEs:"Tras la Guerra Franco-Indígena (1754-1763), impuestos británicos provocaron \"no hay impuestos sin representación\". El Motín del Té (1773) empujó hacia la revolución." },
  { id:62, q:"Who wrote the Declaration of Independence?", a:"Thomas Jefferson", cat:"Colonial Period and Independence", ctx:"Jefferson was just 33 years old when he drafted the Declaration in June 1776 at a boarding house in Philadelphia. A committee of five (including Benjamin Franklin and John Adams) reviewed it, and Congress made further edits, removing a passage condemning the slave trade.", ctxEs:"Jefferson tenía 33 años. Un comité de cinco revisó el texto. El Congreso eliminó un pasaje contra la trata de esclavos." },
  { id:63, q:"When was the Declaration of Independence adopted?", a:"July 4, 1776", cat:"Colonial Period and Independence", ctx:"Congress actually voted for independence on July 2, 1776. July 4th is the date the final wording was approved. Most delegates signed it on August 2nd. John Adams predicted July 2nd would be celebrated with 'pomp and parade' — but July 4th became the holiday instead.", ctxEs:"Votaron independencia el 2 de julio; el 4 aprobaron el texto. Adams predijo que el 2 se celebraría — pero el 4 se convirtió en la festividad." },
  { id:64, q:"There were 13 original states. Name three.", a:"New Hampshire / Massachusetts / Rhode Island / Connecticut / New York / New Jersey / Pennsylvania / Delaware / Maryland / Virginia / North Carolina / South Carolina / Georgia", cat:"Colonial Period and Independence", ctx:"The 13 colonies were established between 1607 (Virginia) and 1733 (Georgia). They stretched along the Atlantic coast and were culturally diverse: New England colonies were centered on religion and trade, the Middle colonies were ethnically diverse, and Southern colonies relied heavily on plantation agriculture and enslaved labor.", ctxEs:"13 colonias entre 1607 (Virginia) y 1733 (Georgia). Nueva Inglaterra: religión/comercio. Centro: diversas. Sur: plantaciones y esclavitud." },
  { id:65, q:"What happened at the Constitutional Convention?", a:"The Constitution was written / The Founding Fathers wrote the Constitution", cat:"Colonial Period and Independence", ctx:"Held in Philadelphia from May to September 1787, the Convention was originally called just to revise the Articles of Confederation. Instead, 55 delegates decided to create an entirely new government. The debates were held in secret so delegates could speak freely. George Washington presided over the Convention.", ctxEs:"Filadelfia, mayo-septiembre 1787. Convocada para revisar los Artículos, 55 delegados crearon gobierno nuevo. Debates secretos. Washington presidió." },
  { id:66, q:"When was the Constitution written?", a:"1787", cat:"Colonial Period and Independence", ctx:"The Constitution was drafted during the hot summer of 1787 in Philadelphia's Independence Hall — the same building where the Declaration of Independence was signed 11 years earlier. It was signed on September 17, 1787, now celebrated as Constitution Day.", ctxEs:"Redactada en el verano de 1787 en Independence Hall — donde se firmó la Declaración 11 años antes. Firmada el 17 de septiembre." },
  { id:67, q:"The Federalist Papers supported the passage of the U.S. Constitution. Name one of the writers.", a:"James Madison / Alexander Hamilton / John Jay / Publius", cat:"Colonial Period and Independence", ctx:"The 85 Federalist Papers were published in New York newspapers in 1787-1788 under the pen name 'Publius.' Hamilton wrote about 51, Madison about 29, and Jay wrote 5. They argued for ratifying the Constitution against 'Anti-Federalists' who feared a too-powerful central government.", ctxEs:"85 ensayos de El Federalista (1787-1788) bajo \"Publius\". Hamilton ~51, Madison ~29, Jay 5. Argumentaron contra Anti-Federalistas." },
  { id:68, q:"What is one thing Benjamin Franklin is famous for?", a:"U.S. diplomat / Oldest member of the Constitutional Convention / First Postmaster General of the United States / Writer of 'Poor Richard's Almanac' / Started the first free libraries", cat:"Colonial Period and Independence", ctx:"Franklin (1706-1790) was perhaps the most versatile Founding Father — inventor (lightning rod, bifocals), scientist, printer, diplomat, and statesman. At 81, he was the oldest delegate at the Constitutional Convention. His diplomatic skills in securing France's alliance during the Revolution were crucial to American independence.", ctxEs:"Franklin (1706-1790): inventor, científico, diplomático. A los 81, el delegado más viejo. Su diplomacia aseguró la alianza francesa, crucial para la independencia." },
  { id:69, q:"Who is the 'Father of Our Country'?", a:"George Washington", cat:"Colonial Period and Independence", ctx:"Washington (1732-1799) led the Continental Army through 8 years of war, presided over the Constitutional Convention, and served as the first President (1789-1797). He voluntarily stepped down after two terms, establishing a precedent that lasted until FDR. King George III reportedly called him 'the greatest man in the world' for willingly giving up power.", ctxEs:"Washington dirigió el ejército 8 años, presidió la Convención y fue primer Presidente. Renunció tras dos mandatos. Jorge III lo llamó \"el hombre más grande del mundo\"." },
  { id:70, q:"Who was the first President?", a:"George Washington", cat:"Colonial Period and Independence", ctx:"Washington was unanimously elected by the Electoral College in both 1789 and 1792 — the only president to achieve this. He established many presidential traditions: the Cabinet system, the two-term limit, and the title 'Mr. President' (rejecting grander titles like 'His Highness').", ctxEs:"Elegido unánimemente en 1789 y 1792. Estableció el Gabinete, límite de dos mandatos y el título \"Sr. Presidente\"." },

  // The 1800s
  { id:71, q:"What territory did the United States buy from France in 1803?", a:"The Louisiana Territory / Louisiana", cat:"The 1800s", ctx:"The Louisiana Purchase doubled the size of the United States overnight — 828,000 square miles for about $15 million (roughly 4 cents per acre). Napoleon sold it to fund his European wars. President Jefferson authorized the deal despite personal doubts about whether the Constitution allowed it.", ctxEs:"La Compra de Luisiana duplicó EE.UU.: 828,000 mi² por ~$15M (~4¢/acre). Napoleón vendió para financiar guerras. Jefferson tenía dudas constitucionales." },
  { id:72, q:"Name one war fought by the United States in the 1800s.", a:"War of 1812 / Mexican-American War / Civil War / Spanish-American War", cat:"The 1800s", ctx:"The War of 1812 against Britain solidified American independence and inspired the national anthem. The Mexican-American War (1846-48) added California and the Southwest. The Civil War (1861-65) was the deadliest in U.S. history. The Spanish-American War (1898) made the U.S. a world power.", ctxEs:"Guerra de 1812 solidificó independencia. México-EE.UU. (1846-48) añadió California. Guerra Civil fue la más mortífera. Hispano-Estadounidense (1898) hizo a EE.UU. potencia." },
  { id:73, q:"Name the U.S. war between the North and the South.", a:"The Civil War / The War between the States", cat:"The 1800s", ctx:"The Civil War (1861-1865) remains the deadliest conflict in American history, with approximately 620,000-750,000 soldiers killed. It began when 11 Southern states seceded to form the Confederate States of America after Abraham Lincoln's election. The war ended with the Confederacy's surrender at Appomattox Court House, Virginia.", ctxEs:"Guerra Civil (1861-1865): ~620,000-750,000 muertos. 11 estados se separaron tras elección de Lincoln. Rendición confederada en Appomattox." },
  { id:74, q:"Name one problem that led to the Civil War.", a:"Slavery / Economic reasons / States' rights", cat:"The 1800s", ctx:"Tensions over slavery had been building for decades. Compromises like the Missouri Compromise (1820) and the Compromise of 1850 temporarily delayed conflict. The Dred Scott decision (1857), John Brown's raid (1859), and Lincoln's election (1860) finally made war inevitable. The South's economy depended on enslaved labor; the North was industrializing.", ctxEs:"Tensiones por esclavitud durante décadas. Compromiso de Missouri (1820), Dred Scott (1857) y elección de Lincoln (1860) hicieron guerra inevitable." },
  { id:75, q:"What was one important thing that Abraham Lincoln did?", a:"Freed the slaves (Emancipation Proclamation) / Saved (preserved) the Union / Led the United States during the Civil War", cat:"The 1800s", ctx:"Lincoln (1809-1865) is widely considered one of America's greatest presidents. Born in a log cabin in Kentucky, he was largely self-educated. He guided the nation through its greatest crisis, preserved the Union, and ended slavery. He was assassinated by John Wilkes Booth at Ford's Theatre just 5 days after the war ended.", ctxEs:"Lincoln (1809-1865): autodidacta de cabaña de troncos. Preservó la Unión y acabó con la esclavitud. Asesinado 5 días después del fin de la guerra." },
  { id:76, q:"What did the Emancipation Proclamation do?", a:"Freed the slaves / Freed slaves in the Confederacy / Freed slaves in the Confederate states / Freed slaves in most Southern states", cat:"The 1800s", ctx:"Issued on January 1, 1863, the Emancipation Proclamation was a strategic wartime measure that freed slaves only in Confederate states — not in border states loyal to the Union. It transformed the war into a fight for freedom and allowed African Americans to enlist. About 180,000 Black soldiers served in the Union Army.", ctxEs:"Emitida el 1 de enero de 1863, liberó esclavos en estados Confederados. Transformó la guerra en lucha por la libertad. ~180,000 soldados negros sirvieron." },
  { id:77, q:"What did Susan B. Anthony do?", a:"Fought for women's rights / Fought for civil rights", cat:"The 1800s", ctx:"Susan B. Anthony (1820-1906) was arrested in 1872 for voting illegally in a presidential election. She co-founded the National Woman Suffrage Association with Elizabeth Cady Stanton and spent 50 years campaigning for women's right to vote. She died 14 years before the 19th Amendment (1920) finally granted it.", ctxEs:"Anthony (1820-1906) arrestada en 1872 por votar. Luchó 50 años por el sufragio femenino. Murió 14 años antes de la Enmienda 19 (1920)." },

  // Recent American History
  { id:78, q:"Name one war fought by the United States in the 1900s.", a:"World War I / World War II / Korean War / Vietnam War / (Persian) Gulf War", cat:"Recent American History", ctx:"The 20th century transformed America into a global superpower. WWI (1917-18) ended U.S. isolationism. WWII (1941-45) established the U.S. as a world leader. The Korean War (1950-53) and Vietnam War (1955-75) were fought to contain communism. The Gulf War (1991) was fought to liberate Kuwait from Iraq.", ctxEs:"Siglo XX: WWI terminó aislacionismo. WWII estableció liderazgo mundial. Corea y Vietnam contra comunismo. Guerra del Golfo (1991) liberó Kuwait." },
  { id:79, q:"Who was President during World War I?", a:"Woodrow Wilson", cat:"Recent American History", ctx:"Wilson (1856-1924) initially kept the U.S. neutral with the slogan 'He kept us out of war.' Germany's unrestricted submarine warfare and the Zimmermann Telegram (proposing a German-Mexican alliance against the U.S.) pushed America to enter in 1917. After the war, Wilson championed the League of Nations, but the U.S. Senate refused to join.", ctxEs:"Wilson mantuvo neutralidad hasta guerra submarina alemana y Telegrama Zimmermann (1917). Promovió Liga de Naciones, Senado rechazó unirse." },
  { id:80, q:"Who was President during the Great Depression and World War II?", a:"Franklin Roosevelt", cat:"Recent American History", ctx:"FDR (1882-1945) served an unprecedented 4 terms (1933-1945). He launched the New Deal to combat the Great Depression — creating Social Security, the SEC, and massive public works programs. After Pearl Harbor (1941), he led the nation through WWII. He died in April 1945, just months before victory.", ctxEs:"FDR: 4 mandatos (1933-1945). New Deal: Seguro Social y obras públicas. Tras Pearl Harbor lideró WWII. Murió abril 1945, antes de la victoria." },
  { id:81, q:"Who did the United States fight in World War II?", a:"Japan, Germany, and Italy", cat:"Recent American History", ctx:"The U.S. entered WWII after Japan bombed Pearl Harbor on December 7, 1941. The 'Axis Powers' (Germany, Italy, Japan) fought against the 'Allied Powers' (U.S., Britain, Soviet Union, and others). The war ended with Germany's surrender in May 1945 and Japan's surrender in August 1945 after atomic bombs were dropped on Hiroshima and Nagasaki.", ctxEs:"Pearl Harbor (7 dic. 1941). Eje vs. Aliados. Rendición alemana mayo 1945, japonesa agosto 1945 tras Hiroshima y Nagasaki." },
  { id:82, q:"Before he was President, Eisenhower was a general. What war was he in?", a:"World War II", cat:"Recent American History", ctx:"Dwight D. Eisenhower (1890-1969) served as Supreme Commander of Allied Forces in Europe. He planned and led D-Day — the June 6, 1944 invasion of Normandy, France — the largest amphibious military operation in history. As President (1953-1961), he built the Interstate Highway System and warned about the 'military-industrial complex.'", ctxEs:"Eisenhower dirigió el Día D (6 junio 1944, Normandía). Como Presidente construyó las Autopistas Interestatales y advirtió sobre el \"complejo militar-industrial\"." },
  { id:83, q:"During the Cold War, what was the main concern of the United States?", a:"Communism", cat:"Recent American History", ctx:"The Cold War (1947-1991) was a geopolitical struggle between the U.S. and the Soviet Union. It included the Korean War, Vietnam War, Cuban Missile Crisis (1962), the Space Race, and a nuclear arms race. It ended with the fall of the Berlin Wall (1989) and the dissolution of the Soviet Union (1991).", ctxEs:"Guerra Fría (1947-1991): EE.UU. vs. URSS. Corea, Vietnam, Crisis de Misiles (1962), Carrera Espacial. Terminó con caída del Muro de Berlín (1989)." },
  { id:84, q:"What movement tried to end racial discrimination?", a:"Civil rights (movement)", cat:"Recent American History", ctx:"The Civil Rights Movement (1950s-1960s) fought to end legalized racial segregation and discrimination. Key events include Brown v. Board of Education (1954), the Montgomery Bus Boycott (1955), sit-ins, Freedom Rides, the March on Washington (1963), and passage of the Civil Rights Act (1964) and Voting Rights Act (1965).", ctxEs:"Movimiento por Derechos Civiles (1950s-60s). Brown vs. Board (1954), Boicot de Montgomery (1955), Marcha sobre Washington (1963), Ley de Derechos Civiles (1964)." },
  { id:85, q:"What did Martin Luther King, Jr. do?", a:"Fought for civil rights / Worked for equality for all Americans", cat:"Recent American History", ctx:"Dr. King (1929-1968) led the Civil Rights Movement using nonviolent resistance, inspired by Mahatma Gandhi. His 'I Have a Dream' speech at the 1963 March on Washington is one of history's greatest orations. He won the Nobel Peace Prize in 1964. He was assassinated in Memphis, Tennessee on April 4, 1968.", ctxEs:"King (1929-1968): resistencia no violenta inspirada en Gandhi. \"Tengo un Sueño\" (1963). Nobel de la Paz 1964. Asesinado en Memphis, 4 abril 1968." },
  { id:86, q:"What major event happened on September 11, 2001, in the United States?", a:"Terrorists attacked the United States / Terrorists took over two planes and crashed them into the World Trade Center in New York City", cat:"Recent American History", ctx:"On 9/11, 19 al-Qaeda terrorists hijacked four planes. Two hit the World Trade Center towers in New York (which collapsed), one hit the Pentagon, and one crashed in a Pennsylvania field after passengers fought back. Nearly 3,000 people were killed. The attacks led to the War on Terror, the invasion of Afghanistan, and creation of the Department of Homeland Security.", ctxEs:"11-S: 19 terroristas, 4 aviones. Torres Gemelas, Pentágono, campo en Pensilvania. ~3,000 muertos. Guerra contra el Terrorismo y Depto. de Seguridad Nacional." },
  { id:87, q:"Name one American Indian tribe in the United States.", a:"Cherokee / Navajo / Sioux / Chippewa / Choctaw / Pueblo / Apache / Iroquois / Creek / Blackfeet / Seminole / Cheyenne / Arawak / Shawnee / Mohegan / Huron / Oneida / Lakota / Crow / Teton / Hopi / Inuit", cat:"Recent American History", ctx:"There are currently 574 federally recognized tribes in the U.S. The Navajo Nation is the largest reservation (27,000 sq. miles across Arizona, Utah, and New Mexico). The Cherokee Nation is the largest tribe by enrollment (~400,000 members). The Iroquois Confederacy's democratic structure may have influenced the U.S. Constitution.", ctxEs:"574 tribus reconocidas. Navajo: reserva más grande (27,000 mi²). Cherokee: tribu más grande (~400,000). La Confederación Iroquesa pudo influir en la Constitución." },

  // Geography
  { id:88, q:"Name one of the two longest rivers in the United States.", a:"Missouri (River) / Mississippi (River)", cat:"Geography", ctx:"The Missouri River (2,341 miles) is technically the longest, but the Mississippi (2,320 miles) is more famous. Together they form the world's 4th longest river system. The Mississippi was crucial to westward expansion and commerce — Mark Twain immortalized it in 'Adventures of Huckleberry Finn.'", ctxEs:"Missouri (2,341 mi) el más largo; Mississippi (2,320 mi) el más famoso. 4° sistema fluvial del mundo. Crucial para expansión hacia el oeste." },
  { id:89, q:"What ocean is on the West Coast of the United States?", a:"Pacific (Ocean)", cat:"Geography", ctx:"The Pacific Ocean is the world's largest and deepest ocean, covering more area than all land on Earth combined. Spanish explorer Vasco Núñez de Balboa was the first European to see it from the Americas in 1513. The U.S. West Coast spans about 7,600 miles from Washington to California.", ctxEs:"El Pacífico es el más grande y profundo del mundo. Balboa fue el primer europeo en verlo desde las Américas (1513)." },
  { id:90, q:"What ocean is on the East Coast of the United States?", a:"Atlantic (Ocean)", cat:"Geography", ctx:"The Atlantic Ocean was the highway for European exploration and colonization of America. The first permanent English settlement (Jamestown, 1607) was on the Atlantic coast. The ocean protected America from European conflicts for much of its early history, contributing to the policy of isolationism.", ctxEs:"El Atlántico fue ruta de exploración europea. Jamestown (1607) en su costa. Protegió a América de conflictos europeos." },
  { id:91, q:"Name one U.S. territory.", a:"Puerto Rico / U.S. Virgin Islands / American Samoa / Northern Mariana Islands / Guam", cat:"Geography", ctx:"Most U.S. territories were acquired after the Spanish-American War (1898) — Puerto Rico and Guam from Spain. The U.S. Virgin Islands were purchased from Denmark in 1917. Residents of territories are U.S. citizens (except American Samoa) but cannot vote in presidential elections and have non-voting delegates in Congress.", ctxEs:"Territorios adquiridos tras Guerra Hispano-Estadounidense (1898). Islas Vírgenes compradas a Dinamarca (1917). Residentes son ciudadanos pero no votan para presidente." },
  { id:92, q:"Name one state that borders Canada.", a:"Maine / New Hampshire / Vermont / New York / Pennsylvania / Ohio / Michigan / Minnesota / North Dakota / Montana / Idaho / Washington / Alaska", cat:"Geography", ctx:"The U.S.-Canada border is the longest international border in the world at 5,525 miles (including Alaska). It was largely established by the Treaty of 1818 along the 49th parallel. The border has been called 'the longest undefended border in the world,' symbolizing the peaceful relationship between the two nations.", ctxEs:"Frontera EE.UU.-Canadá: la más larga del mundo (5,525 mi). Tratado de 1818, paralelo 49. \"La frontera sin defensa más larga\"." },
  { id:93, q:"Name one state that borders Mexico.", a:"California / Arizona / New Mexico / Texas", cat:"Geography", ctx:"The U.S.-Mexico border spans about 1,954 miles. Much of it was established after the Mexican-American War by the Treaty of Guadalupe Hidalgo (1848), when Mexico ceded present-day California, Arizona, New Mexico, and more to the U.S. The Gadsden Purchase (1853) finalized the southern borders of Arizona and New Mexico.", ctxEs:"Frontera EE.UU.-México: ~1,954 mi. Tratado de Guadalupe Hidalgo (1848). Compra de Gadsden (1853) finalizó fronteras de Arizona y Nuevo México." },
  { id:94, q:"What is the capital of the United States?", a:"Washington, D.C.", cat:"Geography", ctx:"Washington, D.C. became the capital in 1800, purpose-built on land donated by Maryland and Virginia. It was designed by French architect Pierre Charles L'Enfant. 'D.C.' stands for District of Columbia, named after Christopher Columbus. The capital was placed between Northern and Southern states as part of a political compromise between Hamilton and Jefferson.", ctxEs:"Capital desde 1800. Diseñada por L'Enfant. Ubicada entre Norte y Sur como compromiso Hamilton-Jefferson." },
  { id:95, q:"Where is the Statue of Liberty?", a:"New York (Harbor) / Liberty Island (in New York or New Jersey)", cat:"Geography", ctx:"The Statue of Liberty was a gift from France in 1886, celebrating the friendship between the two nations and the ideals of freedom and democracy. Designed by Frédéric Auguste Bartholdi with a steel framework by Gustave Eiffel, it stands 305 feet tall. For millions of immigrants arriving by ship, it was their first sight of America.", ctxEs:"Regalo de Francia (1886). Bartholdi la diseñó, Eiffel la estructura. 305 pies. Primera imagen de América para millones de inmigrantes." },

  // Symbols
  { id:96, q:"Why does the flag have 13 stripes?", a:"Because there were 13 original colonies / Because the stripes represent the original colonies", cat:"Symbols", ctx:"The first official U.S. flag was adopted on June 14, 1777 (now celebrated as Flag Day). The 13 alternating red and white stripes have remained constant even as stars were added for new states. Legend says Betsy Ross sewed the first flag, though this is debated by historians.", ctxEs:"Primera bandera adoptada 14 junio 1777 (Día de la Bandera). 13 franjas constantes. Leyenda de Betsy Ross debatida por historiadores." },
  { id:97, q:"Why does the flag have 50 stars?", a:"Because there is one star for each state / Because each star represents a state / Because there are 50 states", cat:"Symbols", ctx:"The flag has been updated 27 times as new states joined. The current 50-star design was created in 1958 by Robert Heft, a 17-year-old high school student from Ohio, as a class project — he received a B- grade. It became official on July 4, 1960, when Hawaii became the 50th state.", ctxEs:"Actualizada 27 veces. Diseño actual por Robert Heft (17 años, proyecto escolar, nota B-). Oficial desde 4 julio 1960 con Hawái." },
  { id:98, q:"What is the name of the national anthem?", a:"The Star-Spangled Banner", cat:"Symbols", ctx:"Francis Scott Key wrote the lyrics in 1814 after watching the British bombardment of Fort McHenry in Baltimore during the War of 1812. Seeing the American flag still flying at dawn inspired the poem. It was set to the melody of a popular British song and became the official national anthem in 1931.", ctxEs:"Key escribió la letra en 1814 al ver Fort McHenry resistir bombardeo británico. Himno oficial desde 1931." },

  // Holidays
  { id:99, q:"When do we celebrate Independence Day?", a:"July 4", cat:"Holidays", ctx:"The first Independence Day celebration was on July 4, 1777, with fireworks, bonfires, and bell-ringing. John Adams and Thomas Jefferson both died on July 4, 1826 — exactly 50 years after the Declaration was adopted. Today, Americans celebrate with fireworks, barbecues, and parades.", ctxEs:"Primera celebración: 4 julio 1777. Adams y Jefferson murieron el 4 julio 1826 — 50 años exactos después de la Declaración." },
  { id:100, q:"Name two national U.S. holidays.", a:"New Year's Day / Martin Luther King, Jr. Day / Presidents' Day / Memorial Day / Independence Day / Labor Day / Columbus Day / Veterans Day / Thanksgiving / Christmas", cat:"Holidays", ctx:"Congress establishes federal holidays. MLK Day (3rd Monday of January) was signed into law in 1983 after a long campaign. Memorial Day originated after the Civil War to honor fallen soldiers. Thanksgiving was proclaimed a national holiday by Lincoln in 1863, during the Civil War, to unite the nation.", ctxEs:"Día de MLK: ley en 1983. Memorial Day: tras Guerra Civil. Acción de Gracias: proclamado por Lincoln en 1863." },

  // Additional questions 101-128
  { id:101, q:"What is self-government?", a:"Powers come from the people / Government responds to the people", cat:"Principles of American Democracy", ctx:"Self-government was a radical idea in the 18th century when most of the world was ruled by monarchs. The concept draws from Enlightenment thinkers like John Locke and Jean-Jacques Rousseau, who argued that governments derive their legitimate authority from the consent of the governed.", ctxEs:"Radical en el siglo XVIII. De Locke y Rousseau: los gobiernos derivan autoridad del consentimiento de los gobernados." },
  ...
  { id:106, q:"What is one right from the Fifth Amendment?", a:"The right to a fair trial / The right not to testify against yourself / The right to a trial by jury in a civil case / The right to vote / The right to liberty", cat:"Principles of American Democracy", ctx:"The Fifth Amendment's protections against self-incrimination ('pleading the Fifth') stem from English history, where accused people were tortured into confessing. The 'due process' clause has become one of the most important constitutional protections, ensuring the government follows fair procedures.", ctxEs:"Protecciones contra autoincriminación (\"acogerse a la Quinta\") vienen de la historia inglesa de tortura para confesar." },
  ...
  { id:112, q:"What was the first capital of the United States?", a:"New York", cat:"Recent American History", ctx:"New York City served as the first U.S. capital from 1785 to 1790. George Washington was inaugurated there at Federal Hall on April 30, 1789. The capital then moved to Philadelphia (1790-1800) while Washington, D.C. was being built.", ctxEs:"Nueva York fue primera capital (1785-1790). Washington investido en Federal Hall. Capital mudada a Filadelfia, luego Washington D.C." },
  { id:113, q:"In what city was the Constitutional Convention held?", a:"Philadelphia", cat:"Colonial Period and Independence", ctx:"Philadelphia was the largest and most important city in the colonies. The Convention met in the Pennsylvania State House (now Independence Hall) — the same building where the Declaration of Independence had been signed in 1776. Philadelphia served as the de facto capital of the Revolution.", ctxEs:"Filadelfia era la ciudad más importante. La Convención se reunió en Independence Hall — donde se firmó la Declaración en 1776." },
  { id:114, q:"What happened to Japanese Americans during World War II?", a:"They were sent to internment camps", cat:"Recent American History", ctx:"After Pearl Harbor, Executive Order 9066 (1942) forced about 120,000 Japanese Americans — two-thirds of whom were U.S. citizens — into internment camps. They lost their homes, businesses, and freedom. In 1988, President Reagan signed the Civil Liberties Act, formally apologizing and providing $20,000 in reparations to each surviving internee.", ctxEs:"Orden 9066 (1942): ~120,000 japoneses-americanos a campos de internamiento. En 1988, Reagan se disculpó y otorgó $20,000 a cada sobreviviente." },
...
export default function App() {
  ...
  const [ctxLang, setCtxLang] = useState("en");
              ...
              {!quizSubmitted ? (
                <div style={{ marginLeft:38 }}>
                  ...
                  {quizShowCtx[q.id] && q.ctx && (
                    <div style={{ color:"#fbbf24", fontSize:12, lineHeight:1.6, marginBottom:8, padding:"10px 12px", background:"#1c1508", borderRadius:8, borderLeft:"3px solid #f59e0b" }}>{getCtx(q)}</div>
                  )}
                ...
                <div style={{ marginLeft:38 }}>
                  ...
                  {q.ctx && (
                    <div style={{ marginTop:8 }}>
                      ...
                      {quizShowCtx[q.id] && (
                        <div style={{ color:"#fbbf24", fontSize:12, lineHeight:1.6, marginTop:6, padding:"10px 12px", background:"#1c1508", borderRadius:8, borderLeft:"3px solid #f59e0b" }}>{getCtx(q)}</div>
                      )}
                    </div>
                  )}
                </div>
                  ...
                  <div style={{ animation:"fadeIn 0.3s ease" }}>
                    ...
                    {currentQ.ctx && (
                      <div style={{ marginBottom:12 }}>
                        <div style={{ display:"flex", gap:8 }}>
                          <button onClick={() => setShowContext(!showContext)} style={{ flex:1, background:"#1c1508", color:"#f59e0b", border:"1px solid #92400e44", borderRadius:10, padding:"10px 14px", fontSize:13, fontWeight:600, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:6, transition:"all 0.15s" }}
                          ...
                          {showContext && currentQ.ctxEs && (
                            <button onClick={() => setCtxLang(l => l === "en" ? "es" : "en")} style={{ background:"#1c1508", color:"#f59e0b", border:"1px solid #92400e44", borderRadius:10, padding:"10px 14px", fontSize:13, fontWeight:600, cursor:"pointer", whiteSpace:"nowrap" }}>
                              🌐 {ctxLang === "en" ? "ES" : "EN"}
                            </button>
                          )}
                        </div>
                        {showContext && (
                          <div style={{ marginTop:8, padding:"14px 16px", background:"#1c1508", borderRadius:10, borderLeft:"3px solid #f59e0b", animation:"fadeIn 0.3s ease" }}>
                            <p style={{ color:"#fbbf24", fontSize:13, lineHeight:1.7, margin:0 }}>{getCtx(currentQ)}</p>
                          </div>
                        )}
                      </div>
                    )}
